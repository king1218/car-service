...
const Login = () => {
  ...
  const navigateToReguster=event=>{
    ...
    return (
        <div >
           <div class="mx-auto lg:mt-20 mt-10 block p-6 rounded-lg shadow-lg bg-white max-w-sm">
  <form onSubmit={handleLoginForm}>
    ...
    <div class="form-group mb-6">
      ...
      <input ref={passwordRef} type="password" class="form-control block
        w-full
        px-3
        py-1.5
        text-base
    ...
    <p onClick={navigateToReguster} class="text-gray-800 mt-6 text-center">Not a member? <a href="#!"
